...
function define_chars()
  ...
  for i, c_attrs in ipairs(c_attr_list) do
    ...
    chars[i].finishing_mvs = define_acs(fa_attr_list[i], "name,distance,fps,dmg_sp,reac,sps,sequence")
  end
