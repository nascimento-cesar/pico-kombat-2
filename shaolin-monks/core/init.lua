...
function define_global_constants()
  action_stack_timeout, backward, debug, flinch_speed, forward, frozen_body_pal_map, frozen_head_pal_map, jump_speed, p1_id, p2_id, projectile_speed, round_duration, sprite_h, sprite_w, stage_offset, swept_speed, walk_speed, x_shift, y_bottom_limit, y_shift, y_upper_limit = 6, -1, {}, 4, 1, "p0c1c2c3c4c5c6c7c8c9cacbcdcecfc", "p0c1c2c374c5c6c8c9cacbcdcecfc", 2, 0, 1, 3, 90, 8, 7, 16, 3, 1, 3, 127 - 36, 2, 127 - 36 - 20
...
function define_characters()
  local characters, special_attacks, c_attr_list, sa_attr_list, c_attr_keys = {}, {}, split(
    ...
    [[fireball,20,4,*a2,false,false,*r1,➡️+➡️+🅾️,#18|$19/7,special_attack;flying_kick,20,4,*a5,false,true,*r2,➡️+➡️+❎,#12|$14/7,special_attack@hat_toss,20,4,*a2,false,false,*r1,⬅️+➡️+🅾️,#$18/7|$20/7,special_attack@shadow_bolt,20,4,*a2,false,false,*r1,⬇️+➡️+🅾️,#18|$20/7,special_attack@acid_spit,20,4,*a2,false,false,*r1,➡️+➡️+🅾️,#29|$30/7,special_attack@freeze,0,4,*a2,false,false,*r4,⬇️+➡️+🅾️,#18|$20/7,special_attack@fire_skull,20,4,*a2,false,false,*r1,⬅️+⬅️+🅾️,#18|$19/7,special_attack@fan_throw,20,4,*a2,false,false,*r1,➡️+➡️+🅾️,#18|$20/7,special_attack@energy_wave,20,4,*a2,false,false,*r1,➡️+⬇️+⬅️+❎,#18|$20/7,special_attack@sai_throw,20,4,*a2,false,false,*r1,⬇️+⬅️+🅾️,#18|$19/7,special_attack@blade_spark,20,4,*a2,false,false,*r1,⬇️+⬅️+🅾️,#18|$20/7,special_attack@spear,20,4,*a2,false,false,*r1,⬅️+⬅️+🅾️,#18|$20/7,special_attack@lightning,20,4,*a2,false,false,*r1,⬇️+➡️+🅾️,#18|$19/7,special_attack]], "@"
