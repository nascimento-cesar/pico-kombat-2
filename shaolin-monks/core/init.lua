...
function define_chars()
  ...
  for i, c_attrs in ipairs(c_attr_list) do
    ...
    chars[i].finishing_mvs = define_acs(fa_attr_list[i], "name,distance,fps,dmg_sp,is_sp_x2,skip_pal_shift,reac,sps,sequence")
  end
