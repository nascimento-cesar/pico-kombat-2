...
function define_characters()
  ...
  for i, c_attrs in ipairs(c_attr_list) do
    ...
    characters[i].finishing_moves = define_actions(fa_attr_list[i], "name,distance,fps,dmg_sprite,sprites,sequence,fmr1_fps,fmr1_sprites,fmr2_fps,fmr2_sprites")
  end

  return characters
end

function define_actions(attr_list, attr_keys)
